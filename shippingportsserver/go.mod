...
replace github.com/sztelzer/01011010/shippingportsmemdatabase => ./../shippingportsmemdatabase

require (
	github.com/sztelzer/01011010/shippingportsmemdatabase v0.0.0-00010101000000-000000000000
